...
from Cursos.models import Alumnos, Clases, Maestros
from Cursos.serializers import AlumnosSerializer, CursosSerializer, MaestrosSerializer
    ...
    def alumnos_add_delete(self, request, pk=None):
        ...
        if self.request.method == "DELETE":
            ...
            alumno = Alumnos.objects.filter(
                nombre__in=request.data["alumno_name"])
            alumno.delete()
            print(clase.alumnos)
            return Response(status=status.HTTP_200_OK)
